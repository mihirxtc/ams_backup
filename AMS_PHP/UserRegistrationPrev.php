  ...
  if (isset($_REQUEST['rSignup'])) {
    ...
    if (($_REQUEST['rName'] == "") || ($_REQUEST['rEmail'] == "") || ($_REQUEST['rPassword'] == "")) {
      ...
      if ($result->num_rows == 1) {
        ...
        $sql = "INSERT INTO requesterlogin_tb(r_name, r_email, r_password) VALUES ('$rName','$rEmail', '$rPassword')";
        if ($conn->query($sql) === TRUE) {
          $regmsg = '<div class="alert alert-success mt-2" role="alert"> Account Successfully Created! Please Login. </div>';
          // Redirect to Login Page after successful signup
          header("Location: http://localhost/AMS/AMS_PHP/Requester/RequesterLogin.php"); // Replace with your actual login page URL
