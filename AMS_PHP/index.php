...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-danger pl-5 fixed-top">
    <a href="index.php" class="navbar-brand">AMS</a>
  ...
  <header class="jumbotron back-image" style="background-image: url(images/main.png);background-size:auto">
    <div class="myclass mainHeading">
      <h1 class="text-uppercase text-danger font-weight-bold">Welcome to AMS</h1>
  ...
  <div class="container">
    ...
    <div class="jumbotron">
      <h3 class="text-center">AMS Services</h3>
      <p>
        AMS Services is India’s leading chain of multi-brand Electronics and Electrical service
        workshops offering
  ...
  <div class="container" id="Contact">
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-center">
        ...
        Ahmedabad - 380015 <br>
        Phone: +00000000 <br>
        <a href="#" target="_blank">www.ams.com</a> <br>

        <br><br>
        <strong>Ahmedabad Branch:</strong> <br>
        AMS Pvt Ltd, <br>
        IIM Area, IIM Campus <br>
        Ahmedabad - 380015 <br>
        Phone: +00000000 <br>
        <a href="#" target="_blank">www.ams.com</a> <br>
